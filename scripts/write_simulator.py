...
content = """\"\"\"Transaction simulator - Piece 4 of the execution adapter.
...
Path('scripts/tx_simulator.py').write_text(content, encoding='utf-8')
print('Wrote scripts/tx_simulator.py')
