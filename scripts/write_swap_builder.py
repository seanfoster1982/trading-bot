...
content = """\"\"\"Jupiter swap builder - Piece 3 of the execution adapter.
...
Path('scripts/jupiter_swap_builder.py').write_text(content, encoding='utf-8')
print('Wrote scripts/jupiter_swap_builder.py')
