...
content = """\"\"\"Telegram notifier - sends bot alerts to your phone.
...
Path('scripts/telegram_notifier.py').write_text(content, encoding='utf-8')
print('Wrote scripts/telegram_notifier.py')
