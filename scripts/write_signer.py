...
content = """\"\"\"Sign and submit - Piece 5 of the execution adapter.
...
Path('scripts/sign_submit.py').write_text(content, encoding='utf-8')
print('Wrote scripts/sign_submit.py')
