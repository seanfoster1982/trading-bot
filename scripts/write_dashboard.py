...
content = """\"\"\"Should-I-go-live dashboard.
...
Path('scripts/go_live_dashboard.py').write_text(content, encoding='utf-8')
print('Wrote scripts/go_live_dashboard.py')

# Fix any \$ that got through
src = Path('scripts/go_live_dashboard.py').read_text(encoding='utf-8')
n_before = src.count(r'\$')
src = src.replace(r'\$', '$')
Path('scripts/go_live_dashboard.py').write_text(src, encoding='utf-8')
print(f'Pre-emptively stripped {n_before} stray backslash-dollar sequences')
