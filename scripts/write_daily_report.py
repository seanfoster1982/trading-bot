...
content = """\"\"\"Daily report - summarize bot activity over a given window.
...
Path('scripts/daily_report.py').write_text(content, encoding='utf-8')
print('Wrote scripts/daily_report.py')
