...
content = '''"""Paper trader - simulates the strategy without executing real trades.
...
Path('scripts/paper_trader.py').write_text(content, encoding='utf-8')
print('Wrote scripts/paper_trader.py')
